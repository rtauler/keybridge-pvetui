...
"<button data-action='prev_view'><span class='icon small'>&#9664;</span><span class='label'>Prev View</span></button>"
...
"<button data-action='vnc_console'><span class='icon small'>&#9635;</span><span class='label'>VNC</span></button>"
...
"<button class='danger' data-action='quit'><span class='icon small'>&#10005;</span><span class='label'>Close</span></button>"
"</div></div>"
